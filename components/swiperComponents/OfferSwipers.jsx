    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.slide}>
          <Image source={images.s1} style={styles.image} />
        </View>
        <View style={styles.slide}>
          <Image source={images.s2} style={styles.image} />
        </View>
        <View style={styles.slide}>
          <Image source={images.s3} style={styles.image} />
        </View>
      </Swiper>
    </SafeAreaView>
  );
