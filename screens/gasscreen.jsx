...
import SearchBar from '../components/gasCylinderComponents/SearchBar'; // Update path if needed
import InputField from '../components/gasCylinderComponents/InputField'; // Update path if needed
import CustomButton from '../components/gasCylinderComponents/CustomButton'; // Update path if needed
...
const GasCylinder = () => {
  ...
  // Tax and Discount Rates (if applicable)
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Heading */}
      <Text style={styles.heading}>Gas Cylinder Payment</Text>
